...
class TermsConditionsScreens extends StatelessWidget {
  const TermsConditionsScreens({Key? key}) : super(key: key);
        ...
        child: ListView(
          children: [
            ...
            Text(
              ...
              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                  fontSize: 16, color: const Color.fromARGB(255, 33, 89, 243)),
              textAlign: TextAlign.justify,
            ),
            Text(
